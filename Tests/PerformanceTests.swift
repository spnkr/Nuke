...
class ImageProcessingPerformanceTests: XCTestCase {
    func testCreatingProcessorIdentifiers() {
        let decompressor = ImageDecompressor(targetSize: CGSize(width: 1, height: 1), contentMode: .aspectFill, upscale: false)
    ...
    func testComparingTwoProcessorCompositions() {
        ...
        let lhs = ImageProcessorComposition([MockImageProcessor(id: "123"), ImageDecompressor(targetSize: CGSize(width: 1, height: 1), contentMode: .aspectFill, upscale: false)])
        let rhs = ImageProcessorComposition([MockImageProcessor(id: "124"), ImageDecompressor(targetSize: CGSize(width: 1, height: 1), contentMode: .aspectFill, upscale: false)])
